...
- **Consented**. Uploads will always check for consent. An AI skill or other system should always check with the commissioner of the assessment before uploading. We may want a specific field in the JSON upload to confirm that consent has been given.
